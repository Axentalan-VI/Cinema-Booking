    ...
    var r = {
                ...
                t(346), n = t(202), t(28), o = t(907), a = function() {
                    ...
                    class t {
                        ...
                        validToggler(r) {
                            ...
                            } : "cardCVC" === r ? e = r => Payment.fns.validateCardCVC(r, this.cardType) : "cardNumber" === r ? e = function(r) {
            ...
            452: r => {
                ...
                l.a = l.type = function(r, e) {
                    ...
                    if ("[object Object]" === a) {
                        for (t in r)
                            if (!l.equal(r[t], e[t]) || !(t in e)) return !1;
                        for (t in e)
                            if (!l.equal(r[t], e[t]) || !(t in r)) return !1;
                        return !0
                    }
                    if ("[object Array]" === a) {
                        if ((t = r.length) !== e.length) return !1;
                        for (; t--;)
                            if (!l.equal(r[t], e[t])) return !1;
                        return !0
                    }
            ...
            28: function(r, e, t) {
                (function() {
                    var e, a, n, o, i, d, c, p, l, s, f, g, u, j, b, h, m, v, x, y, k, w, C, E, $, z, D = [].indexOf || function(r) {
